                                ...
                                <div class="col-md-12">
                                    <form method="POST" class="form-horizontal">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="number" name="nis" disabled class="form-control" value="<?php echo $row->nis; ?>" required="" placeholder="Masukan NIS">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="alamat" class="form-control" value="<?php echo $row->alamat; ?>" required="" placeholder="Masukan Alamat">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div style="text-align:right;">
                                            <a href="<?php echo base_url(); ?>index.php/siswa" class="btn btn-warning"><span class="glyphicon glyphicon-remove"></span> Batal</a>
    ...
    $('form').submit(function(event) { 
        ...
        $.ajax({ 
            ...
            success   : function(data) {
                        console.log(data);
                            if (data.success) {
                                window.location = '<?php echo base_url(); ?>index.php/siswa';
                            }else{
