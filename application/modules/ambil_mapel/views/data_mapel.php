                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <?php 
                                            for ($i=1; $i <= 6; $i++) { 
                                        ?>
                                        <td><a href="ambil_mapel/form_insert_mapel/<?php echo $key->id_siswa; ?>/<?php echo $i; ?>" class="btn btn-primary waves-effect"><span class="glyphicon glyphicon-plus"></span> Tambah Data</a></td>
                                        <?php
                                            }
                                        ?>
                                    </tr>
