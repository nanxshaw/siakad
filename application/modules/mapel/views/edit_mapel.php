                                ...
                                <div class="col-md-12">
                                    <form method="POST" class="form-horizontal">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9">
                                                <input type="text" name="nama" class="form-control" value="<?php echo $row->nama_mapel; ?>" required="" placeholder="Masukan Nama">
                                            </div>
                                        </div>
...
$(document).ready(function() {
    $('form').submit(function(event) { 
        ...
        $.ajax({ 
            type      : 'POST', 
            url       : "<?php echo base_url(); ?>index.php/mapel/edit_data", 
            data      : postForm, 
            dataType  : 'json',
